(function(){
 if(typeof window==="undefined"||typeof window.v112_processar!=="function"){try{console.warn("[bateria integracao] engine ausente");}catch(e){}return;}
...
window.BATERIAS_REGISTRO.push({nome:"integracao",run:function(){
// ════ EXECUÇÃO ════
console.log('═══════════════════════════════════════════════════════════════');
...
if(falhas.length > 0){
  ...
  return {nome:"integracao",ok:total_ok,total:total,falhas:(typeof falhas!=="undefined"?falhas:[])};
}});
})();
