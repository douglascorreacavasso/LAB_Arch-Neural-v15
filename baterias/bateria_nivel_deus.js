(function(){
 if(typeof window==="undefined"||typeof window.v112_processar!=="function"){try{console.warn("[bateria nivel_deus] engine ausente");}catch(e){}return;}
...
window.BATERIAS_REGISTRO.push({nome:"nivel_deus",run:function(){
// ════════════════ EXECUÇÃO ════════════════
console.log('═══════════════════════════════════════════════════════════════');
...
if(falhas.length > 0){
  ...
  return {nome:"nivel_deus",ok:ok,total:TESTS.length,falhas:(typeof falhas!=="undefined"?falhas:[])};
}});
})();
