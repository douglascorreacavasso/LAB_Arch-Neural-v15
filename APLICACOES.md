# 🎯 LAB_ARCH-NEURAL Cortex V15.1 — Aplicações e Casos de Uso
...
LAB_ARCH-NEURAL Cortex V15.1 é uma **arquitetura cognitiva determinística** que combina **três mundos** historicamente separados:
...
@software{cavasso2026archneural,
  ...
  title = {LAB_ARCH-NEURAL Cortex V15.1: A Modular Cognitive Architecture
           with Real Turing Engine and Statistical Reasoning},
  year = {2026},
  publisher = {GitHub},
