...
| Camada | Papel |
|---|---|
| **Engine** (`arch_neural_v15_final.js`) | O cérebro de fato: grafo, propagação, aprendizado, meditação, córtices. Arquivo único, ~22 mil linhas, sem dependências externas. |
...
```
arch_neural_v15_final.js   # o engine (o cérebro)
...
_patches/                  # scripts de patch (aplicar/reverter recursos) — ferramentas de dev
